...
export default function RootLayout({ children }:{children:React.ReactNode}) { return <html lang="en" className={`${sans.variable} ${display.variable} ${mono.variable}`}><body><SmoothScroll/><IntroLoader/><ScrollProgress/><div className="noise"/><Navbar/><CustomCursor/>{children}</body></html>; }
